# generate_dim_station_schema.py
# Script to read stations metadata .csv file, extract column names, infer data types, and 
...
def main():
    ...
    with open(script_path, 'a') as f:
        ...
        f.write('station_id INT IDENTITY(1,1) PRIMARY KEY\n')
        f.write(')\n')
        f.write('END')
